...
# Run passage model
```{r}
# add in 2018 (shad) and 2020-2021 (shad & herring) zero reach & passage info 
    # (temporarily doing it this way to avoid messing up previous code)
...
fish_mod_new
# saveRDS(fish_mod_new, "other/output/fish_jags_mod_02202024d_logit_all_converged_20yr.rds")
```
...
ggsave(
  "other/figures/Figure4_20240220f.png",
  width = 10.5,
  heigh = 5,
  dpi = 600
)
...
# ggsave("other/figures/Figure3_20240220.png", width = 7, height = 5, dpi = 600)
