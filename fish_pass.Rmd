...
fish2017_sum <- fish2017 %>%
  ...
  summarize(first_ping = min(datetime),
  ...
  mutate(attraction = as.duration(interval(start = tag_time,
         ...
         staging = as.duration(interval(start = first_ping_A1,
                                          end = last_ping_A1)),
         transition = as.duration(interval(start = last_ping_A1,
                                          end = last_ping_A4)),
         passage = as.duration(interval(start = tag_time,
                                          end = last_ping_A4)))
