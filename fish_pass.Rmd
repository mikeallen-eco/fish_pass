...
```
# JAGS model for fish "attraction" proportion (p that reach the ladder)
logit-normal with hyperparameter for each fish
```{r}
...
fish_mod_new
# saveRDS(fish_mod_new, "other/output/fish_jags_mod_060122a_logit_all_converged.rds")
```
...
fish_mod_reach
# saveRDS(fish_mod_reach, "other/output/fish_jags_mod_reach_021924_logit_all_converged.rds")
```
# Create Figure 4 - Plot model output - logit
```{r}
