...
fish_mod_new
# saveRDS(fish_mod_new, "other/output/fish_jags_mod_052722a_logit_all_converged.rds")
```
...
fish_mod <- readRDS(here(
  "other",
  "output",
  "fish_jags_mod_052722a_logit_all_converged.rds"
))
...
ggsave(
  "other/figures/jags_nofishhypers_logit_allconverged_run052722a.png",
  width = 7,
  heigh = 5,
  dpi = 400
)
...
ggsave("other/figures/run_size_passage_cor_uncertainfallback_run052722a_logit_20220527_newdata.png",
       height = 4, width = 7,
       dpi = 400)
...
# ggsave("figures/stairstep_20220527.png", width = 7, height = 5, dpi = 400)
